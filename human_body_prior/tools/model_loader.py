...
def load_model(expr_dir, model_code=None, remove_words_in_model_weights=None, load_only_ps=False, disable_grad=True, custom_ps = None, device = torch.device('cuda', index=4)):
    '''
